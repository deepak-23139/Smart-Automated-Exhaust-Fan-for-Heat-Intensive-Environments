...
The Zero Cross Detector synchronizes the control signal with the AC waveform.
Based on the temperature, the ESP32 calculates the required fan speed.
The MOC3021 Optocoupler isolates the control circuit and triggers the BT136 TRIAC.
